...
set :rvm_ruby_string, '1.9.2@photodeco'
set :rvm_type, :user
...
# TODO: temporary
set :domain, "photodeco.pl"
set :application, "photodeco.pl"
set :user, "deploy"
...
set :scm, :git
set :repository, "git@github.com:pithyless/photodeco.git"
set :branch, "master"
...
namespace :deploy do
  ...
  task :restart, :roles => :app, :except => { :no_release => true } do
    run "touch #{current_release}/tmp/restart.txt"
    # warm up passenger
    run "curl -s 'http://photodeco.pl' &> /dev/null; exit 0"
  end
end
...
require './config/boot'
# TODO: require 'hoptoad_notifier/capistrano'
